export default function createCanvasBackground() {
  ...
  class Particle {
    ...
    createParticle(shadowColor = null) {
      c.beginPath()
      c.arc(this.x, this.y, this.radius, Math.PI * 2, false)
      c.closePath()
      c.shadowColor = shadowColor || this.colorArray[this.colorNum]
      c.shadowBlur = 15
  ...
  function animateBackground() {
    ...
    // Create blackhole
    particles[particles.length - 1].createParticle('#ffea00')
